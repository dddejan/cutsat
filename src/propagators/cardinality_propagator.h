 ...
 */
class CardinalityConstraintPropagator : public Propagator<ConstraintTypeCardinality> {
public:
	CardinalityConstraintPropagator(ConstraintManager& constraintManager, SolverState& solverState)
	: Propagator<ConstraintTypeCardinality>(constraintManager, solverState) { }
